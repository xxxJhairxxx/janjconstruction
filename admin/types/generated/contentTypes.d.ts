...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    description_one: Attribute.RichText;
...
export interface ApiGeneralGeneral extends Schema.SingleType {
  ...
  attributes: {
    ...
    social_networks: Attribute.Component<'shared.social-networks', true>;
    facebook_id: Attribute.String;
    pixel_facebook: Attribute.String;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    home_banner: Attribute.Component<'home-sections.home-sections'>;
    home_our_company: Attribute.Component<'home-sections.home-company'>;
    home_our_services: Attribute.Component<'home-sections.home-our-services'>;
    home_middle: Attribute.Component<'home-sections.home-middle'>;
    home_we_work: Attribute.Component<'home-sections.home-we-work'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiMultilanguageMultilanguage extends Schema.SingleType {
  collectionName: 'multilanguages';
  info: {
    singularName: 'multilanguage';
    pluralName: 'multilanguages';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::multilanguage.multilanguage',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    img_small: Attribute.Media;
    img_large: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
